...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    ka: "ჩვენს შესახებ - Ski Rent Fanatic",
  ...
  const descriptions: Record<string, string> = {
    ...
    ka: "გაიგეთ Ski Rent Fanatic-ის შესახებ - თქვენი საიმედო პარტნიორი პრემიუმ თხილამურებისა და სნოუბორდების გაქირავებისთვის გუდაურში. ხარისხიანი აღჭურვილობა და შესანიშნავი სერვისი.",
...
export default async function AboutLayout({
  ...
  return (
    <>
      <StructuredData locale={locale} type="about" />
      {children}
    </>
  );
}
