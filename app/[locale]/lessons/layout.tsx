...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    ka: "თხილამურების გაკვეთილები - Ski Rent Fanatic",
  ...
  const descriptions: Record<string, string> = {
    ...
    ka: "დაჯავშნეთ პროფესიონალური თხილამურებისა და სნოუბორდების გაკვეთილები გუდაურში. გამოცდილი ინსტრუქტორები ყველა დონისთვის. გააუმჯობესეთ თქვენი ტექნიკა და თავდაჯერებულობა ფერდობებზე.",
...
export default async function LessonsLayout({
  ...
  return (
    <>
      <StructuredData locale={locale} type="lessons" />
      {children}
    </>
  );
}
